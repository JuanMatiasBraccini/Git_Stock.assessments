# ------ Script for running whiskery shark stock assessment ---- ###################
...
#Catch in tonnes?  
KTCH.UNITS="KGS"    #thi sis used in Source.data.R then in Run.models.R is converted to tonnes for size-based models
#KTCH.UNITS="TONNES"
...
MIN.DAYS.LARGE=30
  ...
  #last year before targeting practices changed (Simpfendorfer 2000)
Yr_q_change=1982
Yr_q_daily=2006

  #Dropped cpue years
Drop_yr_cpue=c("1980-81","1981-82","1982-83","1983-84")
Drop_yr_cpue_sens=c("1975-76","1976-77","1977-78","1978-79","1979-80","1980-81","1981-82","1982-83")

#Po for surplus production
Po_spm=0.9  #consistent with the Fo value used in Size based model
